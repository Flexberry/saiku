...
function genTotalHeaderRowCells(a,b,c,d,e){for(var f=d[COLUMNS],h=b[COLUMNS],k=c[COLUMNS],l=f.length-2,g="",m=l;0<=m;m--)if(a==h[m]){for(var n=0;n<f[m][k[m]].cells.length;n++){g+="\x3ctr\x3e";for(b=0;b<=l;b++){var t="\x26nbsp;";c=0==m&&0==b?"row":m==b+1?"row_total_corner":m==b&&f[m][k[m]].captions?"row_total_first":m<b+1?"row_total":"row_null";b==l&&(f[m][k[m]].captions&&(t=f[m][k[m]].captions[n]),0==m&&0==k[m]&&(t=f[m][k[m]].captions?t+"\x26nbsp;":"",t+=e?"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e":
"Grand Total"));g+='\x3cth class\x3d"'+c+'"\x3e'+(e?"\x3cdiv\x3e"+t+"\x3c/div\x3e":t)+"\x3c/th\x3e"}c={};b={};if(d[ROWS])for(t=0;t<d[ROWS].length;t++)c[t]=0,b[t]=d[ROWS][t][c[t]].width;for(t=0;t<f[m][k[m]].cells[n].length;t++)g+='\x3ctd class\x3d"data total"\x3e'+f[m][k[m]].cells[n][t].value+"\x3c/td\x3e",d[ROWS]&&(g+=totalIntersectionCells(t+1,d[ROWS].length-1,b,c,d[ROWS]));g+="\x3c/tr\x3e"}k[m]++;k[m]<f[m].length&&(h[m]+=f[m][k[m]].width)}return g}var ROWS="ROWS",COLUMNS="COLUMNS";
...
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f="",h=[],k=[],l=e?e:[],g,m,n,t,p,C=0,s=[],D=null,F=!1,E=!1,H=!1,K=[],B=!0;b&&(D=b.hasOwnProperty("batchSize")?b.batchSize:null,B=b.hasOwnProperty("wrapContent")?b.wrapContent:!0);var x={};x[COLUMNS]=a.rowTotalsLists;x[ROWS]=a.colTotalsLists;var y={},I={},d=[ROWS,COLUMNS],M=a.query&&a.query.queryModel&&a.query.queryModel.details?a.query.queryModel.details.measures.length:0;if("object"===typeof this._options.htmlObject&&
Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&"COLUMNS"===a.query.queryModel.details.axis&&"BOTTOM"===a.query.queryModel.details.location)var O=getAxisLevelsName(a,COLUMNS),E=getDomColumnsLevelsName(this._options.htmlObject),T=getAxisSize(a,ROWS),P=0,O=O.length===E.length?E:_.intersection(E,O);for(var q=0;q<d.length;q++)y[d[q]]=[],I[d[q]]=[];cleanupTotals(d,x);if(x[COLUMNS])for(q=0;q<x[COLUMNS].length;q++)I[COLUMNS][q]=0,y[COLUMNS][q]=x[COLUMNS][q][I[COLUMNS][q]].width;
for(var w=0,Q=l.length;w<Q;w++){var N=w-a.topOffset;g=1;var R=E=t=m=!1;if(x[ROWS])for(q=0;q<x[ROWS].length;q++)I[ROWS][q]=0,y[ROWS][q]=x[ROWS][q][I[ROWS][q]].width;rowWithOnlyEmptyCells=!0;var d="\x3ctr\x3e",r=null;0===w&&(d="\x3cthead\x3e"+d);"object"===typeof this._options.htmlObject&&Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&"COLUMNS"===a.query.queryModel.details.axis&&"BOTTOM"===a.query.queryModel.details.location&&P<O.length&&(q=O[P],q in Saiku.i18n.po_file&&(q=
translate_word(q)),d+='\x3cth class\x3d"row_header" style\x3d"text-align: right;" colspan\x3d"'+T+'" title\x3d"'+O[P]+'"\x3e'+(B?"\x3cdiv\x3e"+q+"\x3c/div\x3e":q)+"\x3c/th\x3e",P+=1);for(var v=0,S=l[w].length;v<S;v++){var u=v-a.leftOffset,r=e[w][v];"COLUMN_HEADER"===r.type&&(E=!0);if("COLUMN_HEADER"===r.type&&"null"===r.value&&(null==n||v<n)){if(!Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE||Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&"BOTTOM"!==a.query.queryModel.details.location||0===M||"MDX"===a.query.type)d+=
'\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e'}else if("COLUMN_HEADER"===r.type)null==n&&(n=v),l[w].length==v+1?t=!0:p=e[w][v+1],t?"null"==r.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(x[ROWS]&&(g=x[ROWS][w+1][I[ROWS][w+1]].span),u=r.value,"All "==u.substr(0,4)&&"s"==u.substr(-1)&&"All"in Saiku.i18n.po_file&&(u=translate_word("All")+u.substr(3,u.length-4)),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+r.value+'"\x3e'+(B?'\x3cdiv rel\x3d"'+
w+":"+v+'"\x3e'+u+"\x3c/div\x3e":u)+"\x3c/th\x3e"):(u=1<v&&1<w&&!m&&v>n?e[w-1][v+1].value!=e[w-1][v].value||e[w-1][v+1].properties.uniquename!=e[w-1][v].properties.uniquename:!1,q=999<g?!0:!1,r.value!=p.value||nextParentsDiffer(e,w,v)||m||u||q?("null"==r.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(x[ROWS]&&(g=x[ROWS][w+1][I[ROWS][w+1]].span),u=r.value,"All "==u.substr(0,4)&&"s"==u.substr(-1)&&"All"in Saiku.i18n.po_file&&(u=translate_word("All")+u.substr(3,u.length-
4)),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0==g?1:g)+'" title\x3d"'+r.value+'"\x3e'+(B?'\x3cdiv rel\x3d"'+w+":"+v+'"\x3e'+u+"\x3c/div\x3e":u)+"\x3c/th\x3e"),g=1):g++),x[ROWS]&&(d+=genTotalHeaderCells(v-a.leftOffset+1,w+1,y[ROWS],I[ROWS],x[ROWS],B));else if("ROW_HEADER"===r.type&&"null"===r.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';else if("ROW_HEADER"===r.type){C==v?m=!0:p=e[w][v+1];var q=e[w-1],u=e[w+1],q=!R&&!m&&(0==v||!topParentsDiffer(e,w,v))&&
r.value===q[v].value,R=!q,G=!1;if(Settings.ALLOW_TABLE_DATA_COLLAPSE)if(0<w&&w<Q-1){if(null==x[ROWS]||v<=S-x[ROWS].length-1){var A=!0;x[COLUMNS]&&0<=N&&v<=isNextTotalsRow(N+1,y,I,x,B)&&(G=!0,A=!1);if(A&&u[v].value==r.value)if(0<v)for(A=0;A<v;A++)if(u[A].value==e[w][A].value)G=!0;else{G=!1;break}else G=!0}}else 0<w&&w==Q-1&&x[COLUMNS]&&0<=N&&v<=isNextTotalsRow(N+1,y,I,x,B)&&(G=!0);u=r.value;"All "==u.substr(0,4)&&"s"==u.substr(-1)&&"All"in Saiku.i18n.po_file&&(u=translate_word("All")+u.substr(3,u.length-
4));u=q?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+w+":"+v+'"\x3e'+(G&&Settings.ALLOW_TABLE_DATA_COLLAPSE?'\x3cspan class\x3d"expander expanded" style\x3d"cursor: pointer;"\x3e\x26#9660;\x3c/span\x3e':"")+u+"\x3c/div\x3e";B||(u=q?"\x26nbsp;":u);q=q?"row_null":"row";G=0;if(!m&&("undefined"==typeof p||"null"===p.value)){var G=1,A=r.properties.dimension,J=r.properties.level,A=A in s?s[A].length-s[A].indexOf(J):1,J=v+1;for(;G<A&&J<=C+1&&"null"!==e[w][J];J++)G=J-v;v=v+G-1}d+='\x3cth class\x3d"'+
q+'" '+(0<G?' colspan\x3d"'+G+'"':"")+"\x3e"+u+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===r.type){u=[];if(_.contains(h,r.value)){for(q=0;q<h.length;q++)h[q]===r.value&&u.push(q);u.push(v)}q=r.value;q in Saiku.i18n.po_file&&(q=translate_word(q));d+='\x3cth class\x3d"row_header"\x3e'+(B?"\x3cdiv\x3e"+q+"\x3c/div\x3e":q)+"\x3c/th\x3e";h.push(r.value);k.push({name:r.value,hierName:function(a){a=a.properties.hierarchy;return a.replace(/[\[\]]/gi,"").split(".")[1]?a.replace(/[\[\]]/gi,"").split(".")[1]:
a.replace(/[\[\]]/gi,"").split(".")[0]}(r)+"/"+r.value});m=!0;C=v;r.properties.hasOwnProperty("dimension")&&(A=r.properties.dimension,A in s||(s[A]=[]),s[A].push(r.properties.level));if(0<u.length){G=0;d="\x3ctr\x3e";0===w&&(d="\x3cthead\x3e"+d);for(q=0;q<k.length;q++)u[G]===q?(f+='\x3cth class\x3d"row_header"\x3e'+(B?"\x3cdiv\x3e"+k[q].hierName+"\x3c/div\x3e":k[q].hierName)+"\x3c/th\x3e",G+=1):f+='\x3cth class\x3d"row_header"\x3e'+(B?"\x3cdiv\x3e"+k[q].name+"\x3c/div\x3e":k[q].name)+"\x3c/th\x3e";
d+=f}}else"DATA_CELL"===r.type&&(F=!0,q="",A=_.isEmpty(r.value)?Settings.EMPTY_VALUE_CHARACTER:r.value,G="",r.properties.hasOwnProperty("image")&&(A=r.properties.hasOwnProperty("image_height")?" height\x3d'"+r.properties.image_height+"'":"",J=r.properties.hasOwnProperty("image_width")?" width\x3d'"+r.properties.image_width+"'":"",A="\x3cimg "+A+" "+J+" style\x3d'padding-left: 5px' src\x3d'"+r.properties.image+"' border\x3d'0'\x3e"),"-"!==A&&""!==A&&r.properties.hasOwnProperty("style")&&(q=" style\x3d'background-color: "+
r.properties.style+"' "),r.properties.hasOwnProperty("link")&&(A="\x3ca target\x3d'__blank' href\x3d'"+r.properties.link+"'\x3e"+A+"\x3c/a\x3e"),r.properties.hasOwnProperty("arrow")&&(G="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+r.properties.arrow+".gif' border\x3d'0'\x3e"),"-"!==A&&""!==A&&(rowWithOnlyEmptyCells=!1),d+='\x3ctd class\x3d"data" '+q+"\x3e"+(B?'\x3cdiv class\x3d"datadiv '+setStyleNegativeNumber(r.properties.raw)+'" alt\x3d"'+r.properties.raw+
'" rel\x3d"'+r.properties.position+'"\x3e':"")+A+G+(B?"\x3c/div\x3e":"")+"\x3c/td\x3e",x[ROWS]&&(d+=genTotalDataCells(u+1,N,y[ROWS],I[ROWS],x,B)))}d+="\x3c/tr\x3e";b.hideEmpty&&"DATA_CELL"===r.type&&rowWithOnlyEmptyCells&&(d="");g="";x[COLUMNS]&&0<=N&&(g+=genTotalHeaderRowCells(N+1,y,I,x,B));F&&D?w<=D?(E||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&(c+=g)):(K.push(d),0<g.length&&K.push(g)):(E||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=K,
b.hasBatchResult=0<K.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
...
SaikuChartRenderer.prototype.process_data_tree=function(a,b,c){var d={};b&&(d.resultset=[],d.metadata=[],d.height=0,d.width=0);var e=d;if("undefined"!=typeof a&&"undefined"!=typeof a.data&&!(null!==a.data&&null!==a.data.error||null===a.data||a.data.cellset&&0===a.data.cellset.length)){var f=a.data.cellset;if(f&&0<f.length){var h=0,k=0,l=!1,g,m,n,t=function(a,b){return a+b};g=0;for(m=f.length;0===k&&g<m;g++)for(var p=0,C=f[g].length;p<C;p++){if(!l)for(;"COLUMN_HEADER"==f[g][p].type&&"null"==f[g][p].value;)g++;
l=!0;if("ROW_HEADER_HEADER"==f[g][p].type){for(;"ROW_HEADER_HEADER"==f[g][p].type;)b&&d.metadata.push({colIndex:p,colType:"String",colName:f[g][p].value}),p++;h=p-1}if("COLUMN_HEADER"==f[g][p].type){k=0;for(n=[];k<=g;)"null"!==f[k][p].value&&n.push(f[k][p].value),k++;b&&d.metadata.push({colIndex:p,colType:"Numeric",colName:n.join(" ~ ")});k=g+1}}l=[];for(n=0;n<=h;n++)l.push(null);g=k;for(m=f.length;g<m;g++)if(""!==f[g][0].value){C=[];n=[];p=k=null;for(n=0;n<=h;n++){if(f[g]&&"null"===f[g][n].value){for(var e=
d,s=0;s<h&&"null"===f[g][s].value;s++)e=e[l[s]];s>n&&(n=s)}if(f[g]&&"null"!==f[g][n].value){if(0===n)for(s=0;s<=h;s++)l[s]=null;"number"==typeof e&&(k[p]={},e=k[p]);p=f[g][n].value;l[n]=p;e.hasOwnProperty(p)||(e[p]={});k=e;e=e[p]}}n=_.clone(l);e=h+1;for(s=f[g].length;e<s;e++){var D=f[g][e],F=D.value||0,E=0!==F,H=D.properties.raw;H&&"null"!==H?F=parseFloat(H):"number"!==typeof D.value&&parseFloat(D.value.replace(/[^a-zA-Z 0-9.]+/g,""))&&(F=parseFloat(D.value.replace(/[^a-zA-Z 0-9.]+/g,"")),E=!1);0<
F&&E&&(F=D.value&&0<=D.value.indexOf("%")?100*F:F);C.push(F);n.push({f:D.value,v:F})}b&&d.resultset.push(n);e=_.reduce(C,t,0);p=null===p?"null":p;k[p]=e;e=d}c&&(this.rawdata=a.data,this.data=d,this.hasProcessed=!0,this.data.height=this.data.resultset.length);return d}$(this.el).find(".canvas_wrapper").text("No results").show()}};
...
g.maxValue=Math.max(g.maxValue,d3.max(b,function(a){return d3.max(a.map(function(a){return a.value}))}));f=b[0].map(function(a,b){return a.axis});var m=f.length;l=g.factor*Math.min(g.w/2,g.h/2);d3.select(a).select("svg").remove();var n=d3.select(a).append("svg").attr("width",g.w+g.ExtraWidthX).attr("height",g.h+g.ExtraWidthY).append("g").attr("transform","translate("+g.TranslateX+","+g.TranslateY+")"),x;for(a=0;a<g.levels-1;a++){var y=(a+1)/g.levels*l*g.factor;n.selectAll(".levels").data(f).enter().append("svg:line").attr("x1",
function(a,b){return y*(1-g.factor*Math.sin(b*g.radians/m))}).attr("y1",function(a,b){return y*(1-g.factor*Math.cos(b*g.radians/m))}).attr("x2",function(a,b){return y*(1-g.factor*Math.sin((b+1)*g.radians/m))}).attr("y2",function(a,b){return y*(1-g.factor*Math.cos((b+1)*g.radians/m))}).attr("class","line").style("stroke","grey").style("stroke-opacity","0.75").style("stroke-width","0.3px").attr("transform","translate("+(g.w/2-y)+", "+(g.h/2-y)+")")}for(a=0;a<g.levels;a++)y=(a+1)/g.levels*l*g.factor,
n.selectAll(".levels").data([1]).enter().append("svg:text").attr("x",function(a){return y*(1-g.factor*Math.sin(0))}).attr("y",function(a){return y*(1-g.factor*Math.cos(0))}).attr("class","legend").style("font-family","sans-serif").style("font-size","10px").attr("transform","translate("+(g.w/2-y+g.ToRight)+", "+(g.h/2-y)+")").attr("fill","#737373").text((a+1)*g.maxValue/g.levels);series=0;a=n.selectAll(".axis").data(f).enter().append("g").attr("class","axis");a.append("line").attr("x1",g.w/2).attr("y1",
...
maxValue:.6,levels:6,ExtraWidthX:0},t="#"+this.cccOptions.canvas;$(t).html("");b.draw(t,h,n,f);this.chart={render:function(){b.draw(t,h,n,f)}};this.render()};
...
f){var h=b.workspace.query,k={},l=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,g=b.workspace.query.helper.getAxis(d),m=g.hierarchies,n,t,p,C,s,D,F,E,H,K=!1,B=!1,x=!1;g&&g.filters&&_.each(g.filters,function(a){"N"==a.flavour&&(n=g["function"],t=a.expressions[0],p=a.expressions[1],x=!0);"Generic"==a.flavour&&(C=a.expressions[0],K=!0)});g&&g.sortOrder&&(s=g.sortOrder,D=g.sortEvaluationLiteral,B=!0);g&&g.aggregators&&0<g.aggregators.length&&(H=g.aggregators[0]);
null!==n&&null===p?E=n+"###SEPARATOR###"+t:null!==n&&null!==p&&null!==t&&(E="custom");B&&null!==s&&(F="customsort");_.each(l,function(a){k[a.uniqueName]={name:a.caption,payload:{n:10,sortliteral:a.uniqueName}}});_.each(m,function(a){_.each(a.levels,function(b){k[a.name]={name:a.caption,payload:{n:10,sortliteral:a.name+".["+b.name+"].CURRENTMEMBER.ORDERKEY"}}})});_.each(g.hierarchies,function(a){for(var b in a.levels);});var m=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),
c[b+"###SEPARATOR###"+d].fun=b,b==n&&p==d&&a[d].payload.n==t&&(E=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e"),b==s&&D==d&&(F=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},y={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},clearfilter:{name:"Clear Filter",i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",
...
"_").toLowerCase(),d={name:a.name,items:{}};d.items["show_totals_nil_"+a.name]={name:b.formatAggregatorName("None","nil",g,a),i18n:!0};d.items["show_totals_sum_"+a.name]={name:b.formatAggregatorName("Sum","sum",g,a),i18n:!0};d.items["show_totals_min_"+a.name]={name:b.formatAggregatorName("Min","min",g,a),i18n:!0};d.items["show_totals_max_"+a.name]={name:b.formatAggregatorName("Max","max",g,a),i18n:!0};d.items["show_totals_avg_"+a.name]={name:b.formatAggregatorName("Avg","avg",g,a),i18n:!0};y.fold_totals.items[c]=
d});$.each(y,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});h=y.fold_totals.items.grand_totals.items;if(H)for(var M in h)M.substring(12)==H&&(h[M].name="\x3cb\x3e"+h[M].name+"\x3c/b");else h.show_totals_not.name="\x3cb\x3e"+h.show_totals_not.name+"\x3c/b";k["10"]={payload:{n:10}};K&&(H=y.filter,H.name="\x3cb\x3e"+H.name+"\x3c/b\x3e",H.items.customfilter.name="\x3cb\x3e"+H.items.customfilter.name+"\x3c/b\x3e");B&&(B=y.sort.items,y.sort.name="\x3cb\x3e"+y.sort.name+"\x3c/b\x3e",F in
B&&(B[F].name="\x3cb\x3e"+B[F].name+"\x3c/b\x3e"));x&&(B=y.limit.items,y.limit.name="\x3cb\x3e"+y.limit.name+"\x3c/b\x3e",E in B&&(B[E].name="\x3cb\x3e"+B[E].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(g,"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(g,"Generic");g.filters.push({flavour:"Generic",
operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:C,expressionType:"Filter",workspace:b.workspace})).render().open();else if("stringfilter"==a)f=function(a,c,d){c=[];c.push(a+('.CurrentMember.Name MATCHES ("(?i).*'+d+'.*")'));b.workspace.query.helper.removeFilter(g,"Generic");g.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},
(new StringFilterModal({axis:d,success:f,query:b.workspace.query,expression:C,expressionType:"Filter",workspace:b.workspace})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(g,"N"),b.synchronize_query(),b.workspace.query.run();else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(g,"N");g.filters.push({flavour:"N",operator:null,"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},
(new CustomFilterModal({axis:d,measures:l,success:f,query:b.workspace.query,func:n,n:t,sortliteral:p})).render().open();else if("customsort"==a)f=function(a,c){g.sortOrder=a;g.sortEvaluationLiteral=c;b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:D,expressionType:"Order"})).render().open();else{if("clearsort"==a)g.sortOrder=null,g.sortEvaluationLiteral=null,b.synchronize_query();else if(0===a.indexOf("show_totals_")){var h=a.substring(12);
...
var s=a.split("###SEPARATOR###")[1];if(-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f))g.sortOrder=f,g.sortEvaluationLiteral=k[s].payload.sortliteral;else if(-1<_.indexOf(["Param"],f))g.sortEvaluationLiteral=k[s].payload.sortliteral;else{var E=[];E.push(k[s].payload.n);(s=k[s].payload.sortliteral)&&E.push(s);b.workspace.query.helper.removeFilter(g,"N");g.filters.push({flavour:"N",operator:null,"function":f,expressions:E})}b.synchronize_query()}b.workspace.query.run()}},items:y}}});c.contextMenu()},
...
t="",p="",C=JSON.stringify({hierarchy:m,uniquename:n,type:"level",action:"delete"})+","+JSON.stringify({hierarchy:m,uniquename:l.properties.uniquename,type:"member",action:"add"}),k=l.properties.uniquename,s={},h=b.workspace.selected_cube,D;Saiku.session.sessionworkspace.cube[h]&&D&&measures||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+h)?Saiku.session.sessionworkspace.cube[h]=new Cube(JSON.parse(localStorage.getItem("cube."+h))):(Saiku.session.sessionworkspace.cube[h]=
new Cube({key:h}),Saiku.session.sessionworkspace.cube[h].fetch({async:!1})),D=Saiku.session.sessionworkspace.cube[h].get("data").dimensions);var F=[];(h=b.workspace.query.helper.getHierarchy(m))&&_.each(h.levels,function(a){F.push(m+".["+a.name+"]")});_.each(D,function(a){a.name==g&&_.each(a.hierarchies,function(a){a.uniqueName==m&&_.each(a.levels,function(a){s[a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"add"})};-1<_.indexOf(F,a.uniqueName)&&
(s[a.name].disabled=!0,s["remove-"+a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"delete"})});a.uniqueName==n&&(t=a.caption,p=a.name);s["keep-"+a.name]=s[a.name];s["include-"+a.name]=JSON.parse(JSON.stringify(s[a.name]));s["keep-"+a.name].payload=C+","+s[a.name].payload})})});s.keeponly={payload:C};s.getchildren={payload:k};s.hasOwnProperty("remove-"+p)&&s.hasOwnProperty("include-"+p)&&(s.showall={payload:s["remove-"+p].payload+", "+s["include-"+
p].payload});D=function(a){var b={},c;for(c in s)null!==a&&a.length<c.length&&c.substr(0,a.length)==a&&(b[c]=s[c]);return b};k={name:{name:"\x3cb\x3e"+e.html()+"\x3c/b\x3e",disabled:!0},sep1:"---------",keeponly:{name:"Keep Only",i18n:!0,payload:C}};"Measures"!=g&&(k.fold1key={name:"Include Level",i18n:!0,items:D("include-")},k.fold2key={name:"Keep and Include Level",i18n:!0,items:D("keep-")},k.fold3key={name:"Remove Level",i18n:!0,items:D("remove-")},k.filterlevel={name:"Filter Level",i18n:!0});
...
Settings.ALLOW_PARAMETERS&&(b.workspace.query.helper.removeParameter(m,h),b.workspace.$el.find(".parameter_input").empty());b.workspace.query.helper.removeLevel(m,h);b.workspace.drop_zones.synchronize_query();b.workspace.query.run(!0)}else"keep"===a.substring(0,a.indexOf("-"))?(h=a.substring(a.indexOf("-")+1),(g=b.workspace.query.helper.getHierarchy(m))&&g.levels.hasOwnProperty(t)&&(d.push({uniqueName:l.properties.uniquename,caption:l.properties.uniquename}),g.levels[t].selection={type:"INCLUSION",
...
for(var b=a.selected_cube.split("/"),c=b[3],d=4,e=b.length;d<e;d++)c+="/"+b[d];Saiku.events.trigger("workspace:new_query",this,{view:this,cube:c});this.query=new Query({cube:{connection:b[0],catalog:b[1],schema:"null"==b[2]?"":b[2],name:decodeURIComponent(c)}},{workspace:a});this.processedParamsURI||(b=Saiku.URLParams.paramsURI(),c=function(a,b){var c=this.query.helper.getAxis(a),d=b.charAt(0),e=b.charAt(b.length-1),m=[],n=[],t="";if("("===d&&")"===e)if(b=Saiku.trimFirstLastChar(b),-1!==b.indexOf("],")){for(var n=
b.split("],")[0].split("].["),d=_.last(n),n=_.first(n,2<n.length?2:1),e=b.split("],")[1].trim(),p=0,C=n.length;p<C;p++)t+="["+Saiku.removeBrackets(n[p])+"].";t=Saiku.trimFirstLastChar(t,"last");this.query.helper.includeLevel(a,t,d,"-1")}else e=b;else e=b;m.push(e);this.query.helper.removeFilter(c,"Generic");c.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:m})}.bind(this),Saiku.URLParams.contains({default_mdx_filter_rows:b.default_mdx_filter_rows})&&c("ROWS",b.default_mdx_filter_rows),
...
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,h,k,l,g,m=0,n=a.length,t=Math.max,p="";m<n;){c=a.charCodeAt(m++)||0;f=a.charCodeAt(m++)||0;g=a.charCodeAt(m++)||0;if(255<t(c,f,g))throw b;h=c>>2&63;c=(c&3)<<4|f>>4&15;k=(f&15)<<2|g>>6&3;l=g&63;f?g||(l=64):k=l=64;p+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
