...
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f="",h=[],k=[],l=e?e:[],g,m,n,t,q,B=0,s=[],C=null,E=!1,D=!1,H=!1,K=[],A=!0;b&&(C=b.hasOwnProperty("batchSize")?b.batchSize:null,A=b.hasOwnProperty("wrapContent")?b.wrapContent:!0);var w={};w[COLUMNS]=a.rowTotalsLists;w[ROWS]=a.colTotalsLists;var x={},I={},d=[ROWS,COLUMNS],M=a.query&&a.query.queryModel&&a.query.queryModel.details?a.query.queryModel.details.measures.length:0;if("object"===typeof this._options.htmlObject&&
Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&"COLUMNS"===a.query.queryModel.details.axis&&"BOTTOM"===a.query.queryModel.details.location)var O=getAxisLevelsName(a,COLUMNS),D=getDomColumnsLevelsName(this._options.htmlObject),T=getAxisSize(a,ROWS),P=0,O=O.length===D.length?D:_.intersection(D,O);for(var p=0;p<d.length;p++)x[d[p]]=[],I[d[p]]=[];cleanupTotals(d,w);if(w[COLUMNS])for(p=0;p<w[COLUMNS].length;p++)I[COLUMNS][p]=0,x[COLUMNS][p]=w[COLUMNS][p][I[COLUMNS][p]].width;
for(var v=0,Q=l.length;v<Q;v++){var N=v-a.topOffset;g=1;var R=D=t=m=!1;if(w[ROWS])for(p=0;p<w[ROWS].length;p++)I[ROWS][p]=0,x[ROWS][p]=w[ROWS][p][I[ROWS][p]].width;rowWithOnlyEmptyCells=!0;var d="\x3ctr\x3e",r=null;0===v&&(d="\x3cthead\x3e"+d);if("object"===typeof this._options.htmlObject&&Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&"COLUMNS"===a.query.queryModel.details.axis&&"BOTTOM"===a.query.queryModel.details.location&&P<O.length){var u=O[P];u in Saiku.i18n.po_file&&
(u=translate_word(u));d+='\x3cth class\x3d"row_header" style\x3d"text-align: right;" colspan\x3d"'+T+'" title\x3d"'+O[P]+'"\x3e'+(A?"\x3cdiv\x3e"+u+"\x3c/div\x3e":u)+"\x3c/th\x3e";P+=1}for(var u=0,S=l[v].length;u<S;u++)if(p=u-a.leftOffset,r=e[v][u],"COLUMN_HEADER"===r.type&&(D=!0),"COLUMN_HEADER"===r.type&&"null"===r.value&&(null==n||u<n)){if(!Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE||Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&"BOTTOM"!==a.query.queryModel.details.location||0===M||"MDX"===a.query.type)d+=
'\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e'}else if("COLUMN_HEADER"===r.type){null==n&&(n=u);l[v].length==u+1?t=!0:q=e[v][u+1];if(t)"null"==r.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(w[ROWS]&&(g=w[ROWS][v+1][I[ROWS][v+1]].span),p=r.value,"All "==p.substr(0,4)&&"s"==p.substr(-1)&&"All"in Saiku.i18n.po_file&&(p=translate_word("All")+p.substr(3,p.length-4)),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+r.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+
v+":"+u+'"\x3e'+p+"\x3c/div\x3e":p)+"\x3c/th\x3e");else{var p=1<u&&1<v&&!m&&u>n?e[v-1][u+1].value!=e[v-1][u].value||e[v-1][u+1].properties.uniquename!=e[v-1][u].properties.uniquename:!1,G=999<g?!0:!1;r.value!=q.value||nextParentsDiffer(e,v,u)||m||p||G?("null"==r.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(w[ROWS]&&(g=w[ROWS][v+1][I[ROWS][v+1]].span),p=r.value,"All "==p.substr(0,4)&&"s"==p.substr(-1)&&"All"in Saiku.i18n.po_file&&(p=translate_word("All")+p.substr(3,
p.length-4)),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0==g?1:g)+'" title\x3d"'+r.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+p+"\x3c/div\x3e":p)+"\x3c/th\x3e"),g=1):g++}w[ROWS]&&(d+=genTotalHeaderCells(u-a.leftOffset+1,v+1,x[ROWS],I[ROWS],w[ROWS],A))}else if("ROW_HEADER"===r.type&&"null"===r.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';else if("ROW_HEADER"===r.type){B==u?m=!0:q=e[v][u+1];var G=e[v-1],p=e[v+1],G=!R&&!m&&(0==u||!topParentsDiffer(e,
v,u))&&r.value===G[u].value,R=!G,F=!1;if(Settings.ALLOW_TABLE_DATA_COLLAPSE)if(0<v&&v<Q-1){if(null==w[ROWS]||u<=S-w[ROWS].length-1){var y=!0;w[COLUMNS]&&0<=N&&u<=isNextTotalsRow(N+1,x,I,w,A)&&(F=!0,y=!1);if(y&&p[u].value==r.value)if(0<u)for(y=0;y<u;y++)if(p[y].value==e[v][y].value)F=!0;else{F=!1;break}else F=!0}}else 0<v&&v==Q-1&&w[COLUMNS]&&0<=N&&u<=isNextTotalsRow(N+1,x,I,w,A)&&(F=!0);p=r.value;"All "==p.substr(0,4)&&"s"==p.substr(-1)&&"All"in Saiku.i18n.po_file&&(p=translate_word("All")+p.substr(3,
p.length-4));p=G?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+(F&&Settings.ALLOW_TABLE_DATA_COLLAPSE?'\x3cspan class\x3d"expander expanded" style\x3d"cursor: pointer;"\x3e\x26#9660;\x3c/span\x3e':"")+p+"\x3c/div\x3e";A||(p=G?"\x26nbsp;":p);G=G?"row_null":"row";F=0;if(!m&&("undefined"==typeof q||"null"===q.value)){var F=1,y=r.properties.dimension,J=r.properties.level,y=y in s?s[y].length-s[y].indexOf(J):1,J=u+1;for(;F<y&&J<=B+1&&"null"!==e[v][J];J++)F=J-u;u=u+F-1}d+='\x3cth class\x3d"'+
G+'" '+(0<F?' colspan\x3d"'+F+'"':"")+"\x3e"+p+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===r.type){G=[];if(_.contains(h,r.value)){for(p=0;p<h.length;p++)h[p]===r.value&&G.push(p);G.push(u)}r.value in Saiku.i18n.po_file?r.value=translate_word(r.value):0<=r.value.indexOf("(All)")&&"(All)"in Saiku.i18n.po_file&&(r.value=r.value.replace("(All)",translate_word("(All)")));d+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+r.value+"\x3c/div\x3e":r.value)+"\x3c/th\x3e";h.push(r.value);k.push({name:r.value,
hierName:function(a){a=a.properties.hierarchy;return a.replace(/[\[\]]/gi,"").split(".")[1]?a.replace(/[\[\]]/gi,"").split(".")[1]:a.replace(/[\[\]]/gi,"").split(".")[0]}(r)+"/"+r.value});m=!0;B=u;r.properties.hasOwnProperty("dimension")&&(y=r.properties.dimension,y in s||(s[y]=[]),s[y].push(r.properties.level));if(0<G.length){F=0;d="\x3ctr\x3e";0===v&&(d="\x3cthead\x3e"+d);for(p=0;p<k.length;p++)G[F]===p?(f+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+k[p].hierName+"\x3c/div\x3e":k[p].hierName)+
"\x3c/th\x3e",F+=1):f+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+k[p].name+"\x3c/div\x3e":k[p].name)+"\x3c/th\x3e";d+=f}}else"DATA_CELL"===r.type&&(E=!0,G="",y=_.isEmpty(r.value)?Settings.EMPTY_VALUE_CHARACTER:r.value,F="",r.properties.hasOwnProperty("image")&&(y=r.properties.hasOwnProperty("image_height")?" height\x3d'"+r.properties.image_height+"'":"",J=r.properties.hasOwnProperty("image_width")?" width\x3d'"+r.properties.image_width+"'":"",y="\x3cimg "+y+" "+J+" style\x3d'padding-left: 5px' src\x3d'"+
r.properties.image+"' border\x3d'0'\x3e"),"-"!==y&&""!==y&&r.properties.hasOwnProperty("style")&&(G=" style\x3d'background-color: "+r.properties.style+"' "),r.properties.hasOwnProperty("link")&&(y="\x3ca target\x3d'__blank' href\x3d'"+r.properties.link+"'\x3e"+y+"\x3c/a\x3e"),r.properties.hasOwnProperty("arrow")&&(F="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+r.properties.arrow+".gif' border\x3d'0'\x3e"),"-"!==y&&""!==y&&(rowWithOnlyEmptyCells=!1),d+=
'\x3ctd class\x3d"data" '+G+"\x3e"+(A?'\x3cdiv class\x3d"datadiv '+setStyleNegativeNumber(r.properties.raw)+'" alt\x3d"'+r.properties.raw+'" rel\x3d"'+r.properties.position+'"\x3e':"")+y+F+(A?"\x3c/div\x3e":"")+"\x3c/td\x3e",w[ROWS]&&(d+=genTotalDataCells(p+1,N,x[ROWS],I[ROWS],w,A)));d+="\x3c/tr\x3e";b.hideEmpty&&"DATA_CELL"===r.type&&rowWithOnlyEmptyCells&&(d="");g="";w[COLUMNS]&&0<=N&&(g+=genTotalHeaderRowCells(N+1,x,I,w,A));E&&C?v<=C?(D||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&
(c+=g)):(K.push(d),0<g.length&&K.push(g)):(D||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=K,b.hasBatchResult=0<K.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
...
SaikuChartRenderer.prototype.process_data_tree=function(a,b,c){var d={};b&&(d.resultset=[],d.metadata=[],d.height=0,d.width=0);var e=d;if("undefined"!=typeof a&&"undefined"!=typeof a.data&&!(null!==a.data&&null!==a.data.error||null===a.data||a.data.cellset&&0===a.data.cellset.length)){var f=a.data.cellset;if(f&&0<f.length){var h=0,k=0,l=!1,g,m,n,t=function(a,b){return a+b};g=0;for(m=f.length;0===k&&g<m;g++)for(var q=0,B=f[g].length;q<B;q++){if(!l)for(;"COLUMN_HEADER"==f[g][q].type&&"null"==f[g][q].value;)g++;
l=!0;if("ROW_HEADER_HEADER"==f[g][q].type){for(;"ROW_HEADER_HEADER"==f[g][q].type;)b&&d.metadata.push({colIndex:q,colType:"String",colName:f[g][q].value}),q++;h=q-1}if("COLUMN_HEADER"==f[g][q].type){k=0;for(n=[];k<=g;)"null"!==f[k][q].value&&n.push(f[k][q].value),k++;b&&d.metadata.push({colIndex:q,colType:"Numeric",colName:n.join(" ~ ")});k=g+1}}l=[];for(n=0;n<=h;n++)l.push(null);g=k;for(m=f.length;g<m;g++)if(""!==f[g][0].value){B=[];n=[];q=k=null;for(n=0;n<=h;n++){if(f[g]&&"null"===f[g][n].value){for(var e=
d,s=0;s<h&&"null"===f[g][s].value;s++)e=e[l[s]];s>n&&(n=s)}if(f[g]&&"null"!==f[g][n].value){if(0===n)for(s=0;s<=h;s++)l[s]=null;"number"==typeof e&&(k[q]={},e=k[q]);q=f[g][n].value;l[n]=q;e.hasOwnProperty(q)||(e[q]={});k=e;e=e[q]}}n=_.clone(l);e=h+1;for(s=f[g].length;e<s;e++){var C=f[g][e],E=C.value||0,D=0!==E,H=C.properties.raw;H&&"null"!==H?E=parseFloat(H):"number"!==typeof C.value&&parseFloat(C.value.replace(/[^a-zA-Z 0-9.]+/g,""))&&(E=parseFloat(C.value.replace(/[^a-zA-Z 0-9.]+/g,"")),D=!1);0<
E&&D&&(E=C.value&&0<=C.value.indexOf("%")?100*E:E);B.push(E);n.push({f:C.value,v:E})}b&&d.resultset.push(n);e=_.reduce(B,t,0);q=null===q?"null":q;k[q]=e;e=d}c&&(this.rawdata=a.data,this.data=d,this.hasProcessed=!0,this.data.height=this.data.resultset.length);return d}$(this.el).find(".canvas_wrapper").text("No results").show()}};
...
var s=a.split("###SEPARATOR###")[1];if(-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f))g.sortOrder=f,g.sortEvaluationLiteral=k[s].payload.sortliteral;else if(-1<_.indexOf(["Param"],f))g.sortEvaluationLiteral=k[s].payload.sortliteral;else{var D=[];D.push(k[s].payload.n);(s=k[s].payload.sortliteral)&&D.push(s);b.workspace.query.helper.removeFilter(g,"N");g.filters.push({flavour:"N",operator:null,"function":f,expressions:D})}b.synchronize_query()}b.workspace.query.run()}},items:x}}});c.contextMenu()},
...
t="",q="",B=JSON.stringify({hierarchy:m,uniquename:n,type:"level",action:"delete"})+","+JSON.stringify({hierarchy:m,uniquename:l.properties.uniquename,type:"member",action:"add"}),k=l.properties.uniquename,s={},h=b.workspace.selected_cube,C;Saiku.session.sessionworkspace.cube[h]&&C&&measures||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+h)?Saiku.session.sessionworkspace.cube[h]=new Cube(JSON.parse(localStorage.getItem("cube."+h))):(Saiku.session.sessionworkspace.cube[h]=
new Cube({key:h}),Saiku.session.sessionworkspace.cube[h].fetch({async:!1})),C=Saiku.session.sessionworkspace.cube[h].get("data").dimensions);var E=[];(h=b.workspace.query.helper.getHierarchy(m))&&_.each(h.levels,function(a){E.push(m+".["+a.name+"]")});_.each(C,function(a){a.name==g&&_.each(a.hierarchies,function(a){a.uniqueName==m&&_.each(a.levels,function(a){s[a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"add"})};-1<_.indexOf(E,a.uniqueName)&&
(s[a.name].disabled=!0,s["remove-"+a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"delete"})});a.uniqueName==n&&(t=a.caption,q=a.name);s["keep-"+a.name]=s[a.name];s["include-"+a.name]=JSON.parse(JSON.stringify(s[a.name]));s["keep-"+a.name].payload=B+","+s[a.name].payload})})});s.keeponly={payload:B};s.getchildren={payload:k};s.hasOwnProperty("remove-"+q)&&s.hasOwnProperty("include-"+q)&&(s.showall={payload:s["remove-"+q].payload+", "+s["include-"+
q].payload});C=function(a){var b={},c;for(c in s)null!==a&&a.length<c.length&&c.substr(0,a.length)==a&&(b[c]=s[c]);return b};k={name:{name:"\x3cb\x3e"+e.html()+"\x3c/b\x3e",disabled:!0},sep1:"---------",keeponly:{name:"Keep Only",i18n:!0,payload:B}};"Measures"!=g&&(k.fold1key={name:"Include Level",i18n:!0,items:C("include-")},k.fold2key={name:"Keep and Include Level",i18n:!0,items:C("keep-")},k.fold3key={name:"Remove Level",i18n:!0,items:C("remove-")},k.filterlevel={name:"Filter Level",i18n:!0});
$.each(k,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});return{callback:function(a,c){var d=[];if("keeponly"===a){var g=b.workspace.query.helper.getHierarchy(m);if(g&&g.levels.hasOwnProperty(q)||"[Measures]"==m)"[Measures]"==m?(d={caption:l.value,name:l.value,type:"EXACT",uniqueName:l.properties.uniquename},b.workspace.query.helper.clearMeasures(),b.workspace.query.helper.includeMeasure(d),b.workspace.sync_query(),b.workspace.query.run()):(d.push({uniqueName:l.properties.uniquename,
caption:l.properties.uniquename}),g.levels[q].selection={type:"INCLUSION",members:d},b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))}else if("filterlevel"===a)d=l.properties.level.substring(l.properties.level.lastIndexOf(".")+1),d=d.replace("[","").replace("]",""),(new SelectionsModal({target:e,name:"Filter Level",key:l.properties.hierarchy+"/"+d,workspace:b.workspace,axis:"ROWS"})).open();else if("remove"===a.substring(0,a.indexOf("-"))){var h=a.substring(a.indexOf("-")+1);
...
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,h,k,l,g,m=0,n=a.length,t=Math.max,q="";m<n;){c=a.charCodeAt(m++)||0;f=a.charCodeAt(m++)||0;g=a.charCodeAt(m++)||0;if(255<t(c,f,g))throw b;h=c>>2&63;c=(c&3)<<4|f>>4&15;k=(f&15)<<2|g>>6&3;l=g&63;f?g||(l=64):k=l=64;q+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(l)}return q}})})(this);
